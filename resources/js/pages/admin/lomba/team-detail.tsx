...
const TeamDetailPage: React.FC<Props> = ({ team }) => {
  ...
  const [editForm, setEditForm] = useState({
    ...
    slot_type: team.slot_type || (team.game === 'PUBG Mobile' ? 'single' : ''),
  });
      ...
      <div className="container mx-auto py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            <Button 
              variant="outline"
              onClick={() => window.open(`/secure-admin-essega/export/${team.game === 'Mobile Legends' ? 'MLplayers' : 'PUBGPlayers'}`, '_blank')}
            >
              Export Data Pemain
            </Button>
          </div>
