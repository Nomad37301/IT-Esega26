...
const BracketPUBG2: React.FC<Props> = ({ user, brackets }) => {
                ...
                <div className="mx-auto max-w-[1350px] px-4 md:px-8 lg:px-12 py-24 mt-8">
                    ...
                    <div className="text-center mb-12">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            ...
                            <br />
                            <span className="text-3xl md:text-4xl text-gray-800">Grand Final</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        {brackets.length > 0 ? (
                            ...
                            <div className="text-center py-20 bg-white rounded-xl border-2 border-gray-300">
                                <p className="text-gray-500 text-lg">Belum ada bracket Grand Final yang tersedia saat ini.</p>
                            </div>
                        )}
                    </div>
                </div>
