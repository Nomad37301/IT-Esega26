...
export function QRCodeSection({ 
    ...
    return (
        <div className="w-full lg:w-2/5 flex flex-col items-center justify-center 
            ...
            <div className="absolute bottom-0 left-0 w-72 h-72 rounded-full bg-gradient-to-tr from-blue-200/20 to-gray-100/40 blur-3xl -z-10 transform -translate-x-1/3 translate-y-1/4"></div>
            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-blue-700 bg-clip-text text-transparent mb-3">
                        {title}
                    </h2>
                    ...
                    <div className="p-6 flex justify-center items-center bg-gradient-to-b from-gray-50 to-white">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                <span className="bg-white/90 backdrop-blur-sm text-blue-600 px-4 py-2 rounded-lg text-sm font-medium shadow-lg">
                                    Klik untuk memperbesar
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-b from-gray-50 to-gray-100/50 p-5 border-t border-gray-100">
                        ...
                        <div className="bg-white rounded-lg p-3 mb-4 border border-gray-100 shadow-sm">
                            ...
                            <div className="text-center mt-2">
                                <span className="font-bold text-lg text-blue-700">{fee}</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-3 border border-gray-100 shadow-sm">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="px-3 py-1 bg-gray-50 rounded-md text-sm font-medium text-blue-700">BNI</span>
                                </div>
                                
                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-gray-600">Nomor Rekening:</span>
                                    <span className="px-3 py-1 bg-gray-50 rounded-md text-sm font-mono font-medium text-blue-700">1868712673</span>
                                </div>
                                
                                <div className="flex items-center justify-between pt-2 mt-2 border-t border-gray-100">
                                    <span className="text-sm text-gray-600">Atas Nama:</span>
                                    <span className="px-3 py-1 bg-gray-50 rounded-md text-sm font-medium text-blue-700">Najwa Zhafir Hanysa</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ol className="text-sm text-gray-600 space-y-3">
                            {instructions.map((instruction, index) => (
                                <li key={index} className="flex items-start gap-3 pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                                    <div className="flex-shrink-0 flex items-center justify-center w-5 h-5 bg-gray-100 text-blue-600 rounded-full font-semibold text-xs mt-0.5">
                                        {index + 1}
                                    </div>
                ...
                <DialogContent className="sm:max-w-lg md:max-w-xl p-0 overflow-hidden bg-white">
                        ...
                        <div className="absolute top-2 right-2 z-10">
                            <button 
                                ...
                                className="bg-white/80 backdrop-blur-sm p-2 rounded-full hover:bg-blue-50 transition-colors duration-200 text-gray-700 hover:text-blue-600"
                            >
                                <X className="h-5 w-5" />
                            </button>
                        </div>
                        ...
                        <div className="bg-gray-50 p-4 border-t border-gray-100 text-center">
                            ...
                            <p className="text-sm font-semibold text-blue-600 mt-1">Biaya pendaftaran: {fee}</p>
                        </div>
                    </div>
                </DialogContent>
            </Dialog>
