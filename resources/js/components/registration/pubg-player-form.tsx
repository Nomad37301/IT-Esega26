...
export function PUBGPlayerForm({ player, index, onChange, onDelete, allPlayers, errorsBE }: PlayerPUBGFormProps) {
    ...
    return (
        <div className="border border-secondary/10 rounded-xl p-5 sm:p-6 w-full bg-white">
            <div className="flex justify-between items-start mb-4 sm:mb-6">
                <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-secondary/5 flex items-center justify-center border border-secondary/10">
                        <span className="text-secondary font-bold text-base sm:text-lg">{index + 1}</span>
                    </div>
                    <div>
                ...
                <Button
                    ...
                    size="icon"
                    onClick={onDelete}
                    className="w-8 h-8 sm:w-9 sm:h-9 text-secondary hover:text-secondary/20 bg-secondary/5 hover:bg-secondary border-secondary/20 transition-all duration-200"
                >
                                ...
                                <div className="space-y-1 sm:space-y-2">
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className={`w-full py-1.5 sm:py-2.5 px-2 sm:px-3 bg-secondary/5/80 hover:bg-secondary/5 text-secondary rounded-md border ${errors[field as keyof PUBGPlayer] ? 'border-red-500' : 'border-gray-200'
                                                    ...
                                                    {fileNames[field as "foto" | "tanda_tangan"]
                                                        ? (
                                                            <span className="flex items-center gap-1">
                                                                ...
                                                                <span className="text-[9px] sm:text-xs text-secondary shrink-0">Klik untuk mengganti</span>
                                                            </span>
                                                        )
                                                        : 'Pilih File'
                                                    }
