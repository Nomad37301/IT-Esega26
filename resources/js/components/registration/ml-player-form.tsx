                                ...
                                <div className="space-y-1 sm:space-y-2">
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className={`w-full py-1.5 sm:py-2.5 px-2 sm:px-3 bg-blue-50/80 hover:bg-blue-50 text-blue-700 rounded-md border ${errors[field as keyof MLPlayer] ? 'border-red-500' : 'border-gray-200'
