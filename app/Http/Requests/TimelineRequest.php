...
class TimelineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category' => ['required', 'in:mobile_legend,pubg,valorant,pubgm,opening,closing'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'category.in' => 'Kategori yang dipilih tidak valid. Pilih antara mobile legend, pubg, valorant, pubgm, opening atau closing.',
        ];
    }
}
