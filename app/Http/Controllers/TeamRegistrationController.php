...
class TeamRegistrationController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            $competitionName = $gameType === 'ml' ? 'Mobile Legends' : 'PUBG';
            ...
            try {
                ...
                if ($isML) {
                    ...
                    if ($existingTeam) {
                        ...
                        return back()->withErrors(['team_name' => 'Nama tim PUBG sudah digunakan. Silakan gunakan nama lain.'])->withInput();
                    }
                    ...
                    // PUBG selalu single slot, tidak perlu set slot_type dan slot_count
                }
