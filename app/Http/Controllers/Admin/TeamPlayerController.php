...
class TeamPlayerController extends Controller
{
    ...
    /**
     * API endpoint untuk mendapatkan data pemain PUBG
     * 
    ...
    public function deleteTeam($game, $id)
    {
        try {
            ...
            $teamInfo = [
                'id' => $team->id,
                'name' => $team->team_name,
                'game' => $game === 'pubg' ? 'PUBG' : 'Mobile Legends'
            ];
            
            // Proses pengembalian slot sebelum menghapus tim
            try {
                $competitionName = $game === 'pubg' ? 'PUBG' : 'Mobile Legends';
            ...
            return response()->json([
                ...
                'redirect' => [
                    ...
                    'params' => [
                        'tab' => $game === 'pubg' ? 'pubg' : 'mobile-legends'
                    ]
                ]
            ]);
        } catch (\Exception $e) {
    ...
    /**
     * API endpoint untuk mendapatkan data pemain PUBG berdasarkan tim
     * 
