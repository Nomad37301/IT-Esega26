...
<head>
    ...
    <title>Konfirmasi Registrasi - <?php echo e($teamName); ?></title>
</head>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 15px 0; color: #4a4a4a;">Halo <strong><?php echo e($email); ?></strong>,</p>
                            <p style="margin: 0 0 20px 0; color: #4a4a4a;">Kami dengan senang hati mengkonfirmasi bahwa tim <strong style="color: #c01515;"><?php echo e($teamName); ?></strong> telah berhasil terdaftar untuk turnamen <strong style="color: #c01515;"><?php echo e(strtoupper($gameType)); ?></strong> di IT Essega 2025!</p>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="<?php echo e($URL); ?>" style="background-color: #c01515; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: bold; letter-spacing: 0.5px; text-transform: uppercase; font-size: 14px; transition: all 0.3s;">
                            ...
                            <p style="margin: 0; word-break: break-all; font-size: 14px;">
                                <a href="<?php echo e($URL); ?>" style="color: #c01515; text-decoration: underline;"><?php echo e($URL); ?></a>
                            </p>
...
<?php /**PATH C:\laragon\www\IT-Esega26\resources\views/emails/team_registered.blade.php ENDPATH**/ ?>